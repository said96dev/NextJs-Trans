...
const MoveForm = ({ onFormDataChange, formData }) => {
  const handleChange = (e) => {
    ...
    console.log('🚀 ~ handleChange ~', formData.elevator)
    onFormDataChange({
      ...formData,
...
"
            ...
            <div className="col-span-full">
              ...
              <input
                ...
                value={formData.itemsToTransport}
                onChange={handleChange}
                placeholder="Bitte geben Sie hier die Möbelstücke, Gegenstände etc. an, die transportiert werden sollen."
                className="w-full p-2 border rounded-md shadow-sm"
              />
            </div>
          </div>
